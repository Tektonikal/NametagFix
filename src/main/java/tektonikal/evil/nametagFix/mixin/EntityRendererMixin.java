...
public class EntityRendererMixin<T extends Entity> {
    ...
    private void yeah(T entity, Text text, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, float tickDelta, Operation<Void> original) {
        if (!NametagFixClient.isItTheLastWorldRenderStage) {
            NametagFixClient.yeah.add(entity);
        } else {
            original.call(entity, text, matrices, vertexConsumers, light, tickDelta);
        }
